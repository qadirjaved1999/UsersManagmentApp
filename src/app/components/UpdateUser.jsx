...
const UpdateUser = () => {
    ...
    if(Object.keys(formData).length > 0) return <SuccessMessage message={"Successfully save"}/>
    return (
        <form className="grid lg:grid-cols-2 w-4/6 gap-4" onSubmit={handleSubmit}>
            ...
            <button className="flex justify-center text-md w-2/6 bg-yellow-400 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-green-500 hover:text-green-500">Update <span><BiBrush size={24} /></span></button>
